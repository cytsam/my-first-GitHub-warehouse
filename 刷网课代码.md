...
categories:
  - 脚本语言
abbrlink: ab1cf09a
date: 2020-11-04 23:16:19
---

刷网课代码

***此代码为刷智慧树/知到的脚本代码，随着时间的流逝，渐渐的对网课的兴趣变弱，然后发现网上有收费刷课的代理，我又不想出钱，又不想看，写下此脚本**
***代码分为第一版和第二版，第一版B站搜学习资料自学写的，第二版通过一系列资料改版来的**
***注意！！！代码第二版建议1.5倍（别弄个50倍，几分钟就刷完），别半夜刷课，会被检测出来的***
本代码仅供个人使用，禁止用于商业用途，出事概不负责。
<!--more-->
脚本功能
第一版（bug存在，写SQL太累，不想改）：
- 自动1.5倍播放，静音
- 检测弹题窗口并关闭
- 自动跳转下一节
第二版：
...
- 自动答题功能，章测试、考试，高准确率
- 自动切换视频，课程、见面课
- 进度统计速率，高倍率可以快速完成任务点，设定范围：(0,+∞)，默认'1.5'倍
